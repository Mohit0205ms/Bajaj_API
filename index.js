...
app.post('/bfhl', (req, res) => {
        ...
        const user_id = "Mohit_Singh_2111981124";
        const email = "mohit1124.be21@chitkarauniversity.edu.in";
        const roll_number = "2111981124";
        const odd_numbers = [];
        const even_numbers = [];
        const alphabets = [];
...
const PORT = "https://vercel.com/mohit0205ms-projects";
app.listen(PORT, () => {
